     ...
     stage('For Parallel Stages') {
      parallel {
        stage('Deploy To Development') {
            agent { label 'DEV' }
            environment {
            DEVDEFAULTAMI = "ami-0287a05f0ef0e9d9a"
            ...
            stages {
                stage('Perform Packer Build') {
                    ...
                    steps { //Assume Role in SreeMasterAccount AWS Account
                        withAWS(role:'DevOpsB29JenkinsAssumeRole', roleAccount:'053490018989', duration: 900, roleSessionName: 'jenkins-session') {
                            sh 'pwd'
                            sh 'ls -al'
            ...
            stages {
                stage('Perform Packer Build') {
                    ...
                    steps { //Assume Role in SREEK8S AWS Account
                        withAWS(role:'DevOpsB29JenkinsAssumeRole', roleAccount:'009412611595', duration: 900, roleSessionName: 'jenkins-session') {
